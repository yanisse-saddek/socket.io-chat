    ...
    socket.on('newUserMessage', data=>{
        ...
        message.map((word) => {
            ...
            if ((wordLowerCase.startsWith("http://") || wordLowerCase.startsWith("https://"))&& isLink){
                messageHTML +=  "<a href=" +word +" target='_blank'>" +word +"</a>" + " "         
            } 
            else if((wordLowerCase.startsWith("http://") || wordLowerCase.startsWith("https://"))&& isImage){
